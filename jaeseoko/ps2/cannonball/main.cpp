...
void DrawObstacle(
    int nObstacle,const int obstacleState[],const double obstacleX[],
    const double obstacleY[],const double obstacleW[],const double obstacleH[])
{
    int i;
    glColor3ub(0,255,0);
    for(i=0; i<nObstacle; i++)
...
public:
    ...
    void Draw(void) const
    {
        ...
        DrawObstacle(nObstacle,obstacleState,
                      obstacleX,obstacleY,
                      obstacleW,obstacleH);
...
int main(void)
{
    ...
    {
        std::cout << "CHECCKCKCKCKCKCKCKC" << std::endl;
        app.RunOneStep();
        app.Draw();
    }
    return 0; 
